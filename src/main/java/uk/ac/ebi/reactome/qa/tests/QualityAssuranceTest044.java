...
@QATest
public class QualityAssuranceTest044 extends QualityAssuranceAbstract {
    ...
    @Override
    String getQuery() {
        return "Match (x)-[r:hasEvent]->(y) OPTIONAL MATCH (x)<-[:created]-(a) WITH x,y,r,a WHERE r.stoichiometry > 1 " +
