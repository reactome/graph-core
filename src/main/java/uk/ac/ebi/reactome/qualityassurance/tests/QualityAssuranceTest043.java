...
@QATest
public class QualityAssuranceTest043 extends QualityAssuranceAbstract {

    @Override
    String getName() {
        return "QATest043-HasCandidateRelationshipDuplication";
    }

    @Override
    String getQuery() {
        return "Match (x)-[r:hasCandidate]->(y) OPTIONAL MATCH (x)<-[:created]-(a) WITH x,y,r,a WHERE r.stoichiometry > 1 " +
