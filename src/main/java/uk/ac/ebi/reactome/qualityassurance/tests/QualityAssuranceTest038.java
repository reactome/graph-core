...
public class QualityAssuranceTest038 extends QualityAssuranceAbstract {
    ...
    @Override
    String getName() {
        return "QATest038-HasModifiedResidueRelationshipDuplication";
    }
    ...
    String getQuery() {
        return "Match (x)-[r:hasModifiedResidue]->(y) OPTIONAL MATCH (x)<-[:created]-(a),(x)-[:species]->(s) WITH x,y,r,a,s " +
                ...
                "x.stableIdentifier AS stIdA, x.displayName AS nameA, y.dbId AS dbIdB, y.displayName AS nameB, a.displayName AS author";
    }
